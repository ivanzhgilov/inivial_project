...
""",
        ...
        "*) Согласно теореме Виета, произведение корней z_1, z_2, z_3, равное q_2, должно быть всегда положительным (q ≠ 0)"],
    3: ["Разложение на линейные множители",
        "Если удается найти разложение ax^3 + bx^2 + cx + d = a(x – x_1)(x – x_2)(x – x_3),",
    ...
    4: ["Формула Кардано",
        ...
        "y1 = u + v,",
        "y2 = - (u + v)/2 + (u - v)/2i√3 = E_1u + E_2v,",
        "y3 = - (u + v)/2 - (u - v)/2 i√3 = E_2u + E_1v,",
        "u = ∛(-q/2+ √(2&D)) ,			v = ∛(-q/2-√(2&D)) ,",
...
def list_prof(theme):
    if theme == "Уравнения третьей степени":
...
def distribution(lesson):
    ...
    if n == 1 or n == 3 or n == 4:
        home = "Уравнения третьей степени"
    else:
        home = "Уравнения четвертой степени"
    return render_template('paragraph.html', title=title, materials=materials, home=home)
